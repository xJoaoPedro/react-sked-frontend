...
export function MobileCard({
  ...
  const cardHeightClass = isLogin ? "h-[420px]" : "h-[600px]";
        ...
        >
          ...
          >
            <div className="absolute inset-0 overflow-hidden rounded-[28px] border border-white/10 bg-[#0D1515]/95 shadow-[0_28px_70px_rgba(0,0,0,0.45)]">
              ...
              <form className="h-full overflow-y-auto px-5 py-5" onSubmit={onLoginSubmit}>
                <div>
                  <div className="mb-4">
                  <p className="text-xs font-medium tracking-[0.24em] text-[#00A676] uppercase">
                    Login
                  </p>
          ...
          >
            <div className="absolute inset-0 overflow-hidden rounded-[28px] border border-white/10 bg-[#0D1515]/95 shadow-[0_28px_70px_rgba(0,0,0,0.45)]">
              ...
              <form className="h-full overflow-y-auto px-5 py-5" onSubmit={onRegisterSubmit}>
                <div>
                  <div className="mb-4">
                  <p className="text-xs font-medium tracking-[0.24em] text-[#00A676] uppercase">
                    Cadastro
